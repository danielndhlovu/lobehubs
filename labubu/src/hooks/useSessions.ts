...
const INITIAL_SESSIONS: ChatSession[] = [
    {
        ...
        lastMessage: 'Let\'s review the PR.',
        updatedAt: Date.now(),
        model: 'my-go-model',
        type: 'group',
        avatars: ['🧑', '👩', '🤖']
...
export const useSessions = () => {
  ...
  const createSession = useCallback(() => {
    const newSession: ChatSession = { id: makeId(), title: 'New Conversation', lastMessage: '', updatedAt: Date.now(), model: 'my-go-model' };
